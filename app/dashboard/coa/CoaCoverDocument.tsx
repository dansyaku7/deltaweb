        ...
        <div className="relative z-10 flex flex-col flex-grow">
              ...
              {data.showKanLogo && (
                <div className="flex flex-col items-end text-right"> 
                  ...
                  <div className="text-[7px] leading-tight font-sans mt-1 space-y-px">
                    <p>SK-KLHK No.00161/LPJ/Labling-1/LRK/KLHK</p><p>7-a.DEC.2023-6.DEC.2028</p><p>Halaman 1 dari {data.totalPages}</p>
                  </div>
                </div>
              )}
            </div>
          ...
          <main className="flex-grow">
            ...
            <div className="px-8 text-xs">
              ...
              <div className="grid grid-cols-[140px_10px_1fr] gap-x-1 gap-y-1.5 mb-5">
                <p className="font-bold self-start">Subject</p><p className="self-start">:</p><div>{data.subjects.length > 0 ? data.subjects.map(s => <p key={s}>- {s}</p>) : <p>-</p>}</div>
                <p className="font-bold self-start pt-2">Sample taken by</p><p className="self-start pt-2">:</p><div className="pt-2">{getSampleTakenByText()}</div>
              </div>
